// app/admin/attendance/absent/page.tsx
"use client";
...
export default function AbsentAttendancePage() {
      ...
      <div className="max-w-[1600px] mx-auto px-6 py-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-slate-400 mt-1">
            Staff members who did not check in today
          </p>
        </div>

        <AttendanceStaffTable
          staffList={attendanceData?.absent?.staff || []}
          type="absent"
          emptyMessage="All staff members checked in today"
        />
      </div>
    </div>
  );
